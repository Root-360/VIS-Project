...
const News = () => {
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        const response = await fetch("http://localhost:2500/api/news");
              ...
              <div className="row gx-6">
                <div className="col-xl-12 col-lg-12 col-md-12">
                  <div className="echo-feature-area-site-title">
                    <h4 className="mb-5">Today Treding News</h4>
                    {newsData ? (
                    ...
                    {/* {newsData.map((news: any) => (
                        <div className="col-xl-3 col-lg-3 col-md-3 col-sm-3">
                          <div className="echo-feature-area-post" key={news.id}>
                            <div className="echo-feature-area-post-img img-transition-scale">
